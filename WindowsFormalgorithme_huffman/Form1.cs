...
namespace algorithme_huffman
{
    public partial class Form1 : Form
    {
      public static int taille;
        ...
        // BOUTON COMPRESSER APPELANT LA METHODE ARBRE POUR LUI PASSER LE CHEMIN SOURCE DU FICHIER ET UN NOMBRE POUR INDIQUER A ARBRE QU'IL DOIT COMPRESSER
        private void buttonbroyer_Click(object sender, EventArgs e)
        {
            int b =0;
            taille = 0;
            string path = textBoxcheminfichier.Text;
            arbre huffman = new arbre(path, b, ref  taille);
            //arbre huffman= new arbre(path,b) ;
